...
MonotoneX.prototype = {
  ...
  point: function(x2, y2) {
    ...
    switch (this._point) {
      ...
      case 2:
        this._point = 3;
        point2(this, slope2(this, t14 = slope3(this, x2, y2)), t14);
        break;
      default:
        point2(this, this._t0, t14 = slope3(this, x2, y2));
        break;
    }
    this._x0 = this._x1, this._x1 = x2;
    this._y0 = this._y1, this._y1 = y2;
...
//# sourceMappingURL=chunk-HSBUN4UU.js.map
