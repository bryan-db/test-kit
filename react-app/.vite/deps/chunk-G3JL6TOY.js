...
import {
  ...
  useForkRef_default,
  useId_default
} from "./chunk-ROOT24ER.js";
import {
  globalCss,
  internal_createExtendSxProp,
  useDefaultProps
} from "./chunk-N7X3MN2I.js";
import {
  _extends,
  alpha,
  composeClasses,
  ...
  useRtl,
  useTheme
} from "./chunk-FBZ4MW7S.js";
import {
  clsx_default,
  require_react_is
} from "./chunk-P2YSH5XK.js";
import {
  require_jsx_runtime
...
var Tab = React75.forwardRef(function Tab2(inProps, ref) {
  ...
  return (0, import_jsx_runtime55.jsxs)(TabRoot, {
    ...
    ...other,
    children: [iconPosition === "top" || iconPosition === "start" ? (0, import_jsx_runtime55.jsxs)(React75.Fragment, {
      children: [icon, label]
    }) : (0, import_jsx_runtime55.jsxs)(React75.Fragment, {
      children: [label, icon]
    }), indicator]
  });
});
...
var TablePaginationActions = React84.forwardRef(function TablePaginationActions2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTablePaginationActions"
  });
...
var Tabs = React88.forwardRef(function Tabs2(inProps, ref) {
  ...
  let childIndex = 0;
  const children2 = React88.Children.map(childrenProp, (child) => {
...
//# sourceMappingURL=chunk-G3JL6TOY.js.map
